        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
            {[
              ...
              {
                text: "Content Strategy & Writing",
                icon: "services-icon-2.svg",
              },
              {
                text: "Influencer Marketing  (2500 + influencers)",
          ...
          <div className="text-center mb-8">
            <p className="text-sm sm:text-base md:text-lg">
              When you collaborate with us, our team of expert strategists and
              content creators will craft a personal brand that delivers
              powerful results.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 mt-8">
            {[
              ...
              {
                text: "High-quality Enquiries / Leads",
                icon: "services-icon-2.svg",
              },
              {
                text: "Constant Revenue Growth",
                icon: "content-effect-icon-1.svg",
              },
              {
                text: "Stronger Reputation & Credibility",
                icon: "content-effect-icon-4.svg",
              },
              {
                text: "Boost Prospect / Client engagement",
                icon: "content-effect-icon-5.svg",
              },
            ].map((effect, index) => (
              <div
                key={index}
