          ...
          <div className="flex-1 lg:w-1/2 p-4">
            <div className="flex flex-col justify-start gap-y-3 sm:gap-2">
              {[
                ...
                { src: "https://acciocontent.com/auction.svg", text: "Sr. Executives & Management " },
                { src: "https://acciocontent.com/monitor.svg", text: "Business Leaders " },
                { src: "https://acciocontent.com/toothbrush.svg", text: "Investors" },
                { src: "https://acciocontent.com/user.svg", text: "Aspiring Influencers " },
              ].map((item, index) => (
